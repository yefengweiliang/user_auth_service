package com.user.excel.imports;
...
public class ImportExcel{
        ...
        if (cell != null) {
            switch (cell.getCellType()) {
                ...
                case Cell.CELL_TYPE_NUMERIC:
                    result = ExcelUtil.numOfImport(cell);
                    break;
    ...
    private static void setAttrributeValue(Object obj,String attribute,String value) {
        ...
        for (Method method : methods) {
             ...
             */
            if(method.getName().substring(method.getName().lastIndexOf(".")+1, method.getName().length()).equals(method_name))
            {
